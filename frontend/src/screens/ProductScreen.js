...
//                 <Button onClick={addToCartHandler} className="btn-block" type="buton" disabled={product.countInStock === 0} >Add To Cart</Button>
...
const ProductScreen = () => {
  ...
  return (
    <>
      <Link className='btn btn-secondary goback-btn' to='/products'>
        Go Back
      </Link>
      {isLoading ? (
        <Loader />
